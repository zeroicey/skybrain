  ...
  return (
    <Card className="bg-card border-border h-full">
      ...
      <CardContent className="space-y-4">
        {/* 无人机状态 */}
        <div>
          <div className="text-xs text-muted-foreground mb-2">无人机状态</div>
          <div className="grid grid-cols-4 gap-2">
            ...
            <div className="text-center p-2 bg-muted/50 rounded-lg">
              ...
              <div className="text-xs text-muted-foreground">飞行中</div>
            </div>
            <div className="text-center p-2 bg-muted/50 rounded-lg">
            ...
            <div className="text-center p-2 bg-muted/50 rounded-lg">
              <div className="text-sm font-bold text-foreground">{idleDrones}</div>
        ...
        {/* 电池健康 */}
        <div>
          <div className="text-xs text-muted-foreground mb-2">电池健康</div>
          <div className="flex gap-2 text-xs">
            ...
            <div className="flex-1 p-2 bg-muted/50 rounded-lg text-center">
              ...
              <div className="text-muted-foreground">需维护</div>
            </div>
          </div>
        </div>
        ...
        {/* 飞行统计 */}
        <div>
          <div className="text-xs text-muted-foreground mb-2">累计飞行数据</div>
          <div className="grid grid-cols-2 gap-2">
            <div className="p-2 bg-muted/50 rounded-lg">
              <div className="text-sm font-bold">{avgFlightTime}h</div>
              <div className="text-xs text-muted-foreground">平均飞行时长</div>
            </div>
            <div className="p-2 bg-muted/50 rounded-lg">
              <div className="text-sm font-bold">{totalFlights}</div>
              <div className="text-xs text-muted-foreground">总起降次数</div>
            </div>
          </div>
        </div>
      </CardContent>
