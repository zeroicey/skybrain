...
import { Users, TrendingUp, AlertTriangle, Clock, Building2, Camera, Wifi, Activity } from 'lucide-react'
import { useBuildingStore } from '@/stores/building-store'
import { generateAreaDistribution, buildingCameras } from '@/data/mock-buildings'
...
export default function BuildingPage() {
  ...
  const [selectedCamera, setSelectedCamera] = useState(buildingCameras[0].id)
  ...
  const camerasFiltered = useMemo(() => buildingCameras.filter((c) => c.buildingId === selectedBuildingId), [selectedBuildingId])
      ...
      <div className="flex gap-3">
        <div className="w-[280px] flex-shrink-0 flex flex-col justify-around overflow-hidden">
          ...
          <div className="min-h-[100px]">
            <h3 className="text-xs font-medium mb-1 text-muted-foreground">区域人数</h3>
        ...
        <div className="w-[240px] flex-shrink-0 flex flex-col">
          ...
          <div className="flex-1">
            <h3 className="text-xs font-medium mb-1 text-muted-foreground">教室使用率</h3>
            <div className="h-[calc(100%-20px)] flex items-center justify-center">
              <div className="text-center">
                <Building2 className="w-6 h-6 text-blue-500 mx-auto mb-1" />
                <span className="text-xl font-bold">{statCardData.classroomUsage}%</span>
              </div>
            </div>
          </div>
